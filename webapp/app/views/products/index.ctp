...
foreach($products as $product) {
	...
	echo "<span class='expand_box'><p class='expand_links'><a href='".$product['Product']['product_url']."'><img src='/img/home.png'/></a> <a href='products/delete/".$product['UsersProduct']['id']."'><img src='/img/delete.png'/></a></p></span></span>";
	echo "</li>";
}
?>
